...
public class MailFolder implements IFolder {
	...
	// constructor
	public MailFolder(File path, String name) throws IOException {
	...
	@Override
	public Object remove(Object item)  throws IOException{ // name??? //*
	...
	public void clearInTrash(DoublyLinkedList list){
	    Date current = new Date();
	    for(int i = 0 ; i<list.size() ; i++){
	        Info temp = (Info)list.traverse();
